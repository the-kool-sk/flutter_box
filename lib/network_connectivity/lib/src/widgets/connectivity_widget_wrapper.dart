...
class ConnectivityWidgetWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool _isOffline = Provider.of<ConnectivityStatus>(context) != ConnectivityStatus.CONNECTED;
    Widget _finalOfflineWidget = Align(
      ...
      child: offlineWidget ??
          Container(
            ...
            decoration: decoration ?? BoxDecoration(color: color ?? Colors.red.shade300),
            child: Center(
              child: Text(
